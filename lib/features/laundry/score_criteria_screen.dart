        ...
        children: [
          ...
          const _InfoCard(
            ...
            body: '기상청 시간별 예보와 에어코리아 미세먼지를 바탕으로 '
                ...
                '최대 16시간 동안의 건조력을 누적해서 "빨래가 마르는 데 필요한 양"과 비교하여 '
                '0~100점으로 환산합니다. 즉 한 시점의 날씨가 아니라 '
                '그 시각에 빨래를 널면 이후 얼마나 잘 마를지를 본 점수이고, '
                '목표량에 도달하는 순간을 계산해 "몇 시에 다 마르는지"도 함께 보여줍니다.',
          ),
          ...
          const _InfoCard(
            icon: Icons.schedule,
            title: '오늘(00~24) 안에서 최적 시작 시점 선택',
            body: '오늘 남은 시간 동안 1시간 간격으로 빨래 시작 후보를 만들어, '
                '각 후보마다 (세탁기 45분 후) 빨래를 너는 시점부터 최대 16시간의 누적 건조력을 산출합니다. '
                '최고 점수와 큰 차이가 없으면 아침 7시~밤 10시 사이의 "가장 이른" 시작을 추천하고 '
                '(새벽 세탁 추천 방지), 동점이면 빨래가 더 빨리 마르는 쪽을 우선합니다. '
                '강수가 추천 시점 직전·직후에 있거나 실제 일몰까지 충분히 마르지 않으면 점수가 감점됩니다. '
                '오늘 안에 추천할 만한 시간이 없으면 구체 시각 없이 "내일 추천"으로 표시합니다.',
          ),
          const _InfoCard(
